    ...
    <header className="bg-white"> 
                <div className="mx-auto bg-blue-400 px-4 py-2 flex items-center justify-between">
                    ...
                    <ul className="ml-4 xl:w-48 flex items-center justify-end">
                        ...
                        <Link className="" to={ showLogoutBtn ? '/products': '/auth/userlogin'}>
                        ...
                        {showLogoutBtn && 
                        <li className="ml-2 lg:ml-4 relative inline-block">
                            <p className="text-white bg-black md:font-semibold md:px-3 md:py-1 rounded-lg px-2 py-1 cursor-pointer" onClick={userlogout}>Logout</p>
                        </li>
                        }
                    </ul>
                    </nav>
